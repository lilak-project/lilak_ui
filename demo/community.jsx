...
const api = {
  ...
  async setNotice(id, on) { const m = store.messages.find((x) => x.id === id); if (m) m.notice = !!on; return m },
...
const realApi = {
  ...
  setNotice: (id, on) => j('POST', '/api/community/messages/' + id + '/notice', { notice: on }),
